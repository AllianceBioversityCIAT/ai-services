...
if user_input:
    ...
    # filter_context = f"[Phase: {phase} | Indicator: {indicator} | Section: {section}]"
    # enriched_query = f"{filter_context} {user_input}"
    
    with st.spinner("Thinking..."):
        try:
            # response_stream = query_knowledge_base(enriched_query)
