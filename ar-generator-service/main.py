...
vector_database = "knowledgebase"  # Options: "knowledge_base", "opensearch", "supabase"
...
if __name__ == "__main__":
    if vector_database == "knowledgebase":
        ...
        raise ValueError("Invalid vector database option. Choose from 'knowledge_base', 'opensearch', or 'supabase'.")