  ...
  async run() {
    new sst.aws.Nextjs("BulkUploadWeb", {
      ...
      environment: {
        ...
        CLARISA_API_BASE_URL: process.env.CLARISA_API_BASE_URL ?? process.env.NEXT_PUBLIC_CLARISA_API_BASE_URL ?? "",
        CLARISA_PARTNER_REQUEST_CREATE_URL: process.env.CLARISA_PARTNER_REQUEST_CREATE_URL ?? "",
        CLARISA_VALIDATE_URL: process.env.CLARISA_VALIDATE_URL ?? "",
        BULK_UPLOAD_API_KEY: process.env.BULK_UPLOAD_API_KEY ?? "",
        CLARISA_API_KEY: process.env.CLARISA_API_KEY ?? "",
