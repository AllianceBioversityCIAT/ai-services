...
export const RESULTS_TABLE_COLUMNS: ColumnDef[] = [
  ...
  { key: 'contract_code', label: 'Contract Code', type: 'text', width: '150px' },
  ...
  { key: 'trainees_description', label: 'Trainees Organizations', type: 'partners', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '205px' },
  ...
  { key: 'trainee_affiliation', label: 'Trainee Affiliation', type: 'affiliation', enabledWhen: { field: 'training_type', values: ['Individual training'] }, width: '205px' },
  ...
  { key: 'training_supervisor', label: 'Training Supervisor', type: 'staff', width: '205px' },
