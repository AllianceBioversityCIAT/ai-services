...
export const RESULTS_TABLE_COLUMNS: ColumnDef[] = [
  ...
  {
    key: 'main_contact_person.similarity_score',
    label: 'Main Contact Similarity',
    type: 'number',
  },
  ...
  {
    key: 'training_supervisor.similarity_score',
    label: 'Supervisor Similarity',
    type: 'number',
  },
  ...
  {
    key: 'trainee_affiliation.similarity_score',
    label: 'Affiliation Similarity',
    type: 'number',
  },
