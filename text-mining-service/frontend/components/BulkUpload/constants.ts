...
export const RESULTS_TABLE_COLUMNS: ColumnDef[] = [
  ...
  { key: 'status', label: 'Status', type: 'status', readonly: true, width: '115px' },
  ...
  { key: 'description', label: 'Description', type: 'textarea', width: '500px' },
  { key: 'year', label: 'Year', type: 'text', width: '75px' },
  { key: 'main_contact_person', label: 'Main Contact Name', type: 'staff', width: '200px' },
  { key: 'keywords', label: 'Keywords', type: 'chips', width: '400px' },
  { key: 'contract_code', label: 'Contract Code', type: 'text', width: '125px' },
  { key: 'sdg_targets', label: 'SDG Targets', type: 'sdg', width: '150px' },
  { key: 'training_type', label: 'Training Type', type: 'select', options: ['Individual training', 'Group training'], width: '185px' },
  { key: 'training_category', label: 'Training Category', type: 'select', options: ['Training', 'Engagement'], width: '155px' },
  { key: 'length_of_training', label: 'Length of Training', type: 'select', options: ['Short-term', 'Long-term'], width: '160px' },
  ...
  { key: 'total_participants', label: 'Total Participants', type: 'number', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '155px' },
  { key: 'male_participants', label: 'Male Participants', type: 'number', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '155px' },
  { key: 'female_participants', label: 'Female Participants', type: 'number', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '155px' },
  { key: 'non_binary_participants', label: 'Non-binary Participants', type: 'number', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '185px' },
  { key: 'training_purpose', label: 'Training Purpose', type: 'training_purpose', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '240px' },
  { key: 'trainees', label: 'Trainees', type: 'select', options: ['Yes', 'No'], enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '155px' },
  { key: 'trainees_description', label: 'Trainees Organizations', type: 'partners', enabledWhen: { field: 'training_type', values: ['Group training'] }, width: '190px' },
  ...
  { key: 'trainee_affiliation', label: 'Trainee Affiliation', type: 'affiliation', enabledWhen: { field: 'training_type', values: ['Individual training'] }, width: '200px' },
  { key: 'trainee_nationality', label: 'Trainee Nationality', type: 'nationality', enabledWhen: { field: 'training_type', values: ['Individual training'] }, width: '200px' },
  { key: 'training_supervisor', label: 'Training Supervisor', type: 'staff', width: '200px' },
  { key: 'language', label: 'Language', type: 'language', width: '200px' },
  { key: 'start_date', label: 'Start Date', type: 'date', width: '150px' },
  { key: 'end_date', label: 'End Date', type: 'date', width: '150px' },
  { key: 'delivery_modality', label: 'Delivery Modality', type: 'select', options: ['in-person', 'virtual', 'hybrid'], width: '160px' },
  { key: 'partners', label: 'Partners', type: 'partners', width: '155px' },
  {
    key: 'geoscope_level',
