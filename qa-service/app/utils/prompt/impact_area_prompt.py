...
For each Impact Area, do the following:
  ...
  1. Evaluate whether the user-selected score is appropriate given:
    ...
    • If the user selected “(2) Principal”, explicitly note that Principal selection requires explicit primary-focus evidence in metadata/evidence; if missing/ambiguous, state that the information does not clearly support this level and suggest adding specific evidence.
